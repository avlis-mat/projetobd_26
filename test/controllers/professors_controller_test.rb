...
class ProfessorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create professor" do
    assert_difference("Professor.count") do
      post professors_url, params: { professor: { dt_contratacao: @professor.dt_contratacao, idUsuario: @professor.idUsuario } }
    end
  ...
  test "should update professor" do
    patch professor_url(@professor), params: { professor: { dt_contratacao: @professor.dt_contratacao, idUsuario: @professor.idUsuario } }
