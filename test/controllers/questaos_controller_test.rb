...
class QuestaosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create questao" do
    assert_difference("Questao.count") do
      post questaos_url, params: { questao: { Atualizado_em: @questao.Atualizado_em, Criado_em: @questao.Criado_em, Enunciado: @questao.Enunciado, Status: @questao.Status, Versao: @questao.Versao } }
    end
  ...
  test "should update questao" do
    patch questao_url(@questao), params: { questao: { Atualizado_em: @questao.Atualizado_em, Criado_em: @questao.Criado_em, Enunciado: @questao.Enunciado, Status: @questao.Status, Versao: @questao.Versao } }
