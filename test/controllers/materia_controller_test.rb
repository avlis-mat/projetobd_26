...
class MateriaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create materium" do
    assert_difference("Materium.count") do
      post materia_url, params: { materium: { Codigo: @materium.Codigo, Nome: @materium.Nome, Semestre: @materium.Semestre, idDepartamento: @materium.idDepartamento } }
    end
  ...
  test "should update materium" do
    patch materium_url(@materium), params: { materium: { Codigo: @materium.Codigo, Nome: @materium.Nome, Semestre: @materium.Semestre, idDepartamento: @materium.idDepartamento } }
