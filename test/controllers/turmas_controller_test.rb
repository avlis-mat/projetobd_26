...
class TurmasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create turma" do
    assert_difference("Turma.count") do
      post turmas_url, params: { turma: { Codigo: @turma.Codigo, Horario: @turma.Horario, Turno: @turma.Turno, idMateria: @turma.idMateria } }
    end
  ...
  test "should update turma" do
    patch turma_url(@turma), params: { turma: { Codigo: @turma.Codigo, Horario: @turma.Horario, Turno: @turma.Turno, idMateria: @turma.idMateria } }
