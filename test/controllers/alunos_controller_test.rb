...
class AlunosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create aluno" do
    assert_difference("Aluno.count") do
      post alunos_url, params: { aluno: { Matricula: @aluno.Matricula, Semestre: @aluno.Semestre, Tipo_graduacao: @aluno.Tipo_graduacao, idUsuario: @aluno.idUsuario } }
    end
  ...
  test "should update aluno" do
    patch aluno_url(@aluno), params: { aluno: { Matricula: @aluno.Matricula, Semestre: @aluno.Semestre, Tipo_graduacao: @aluno.Tipo_graduacao, idUsuario: @aluno.idUsuario } }
