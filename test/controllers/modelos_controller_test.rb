...
class ModelosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create modelo" do
    assert_difference("Modelo.count") do
      post modelos_url, params: { modelo: { Atualizado_em: @modelo.Atualizado_em, Criado_em: @modelo.Criado_em, Descricao: @modelo.Descricao, Nome: @modelo.Nome, Status: @modelo.Status, Versao: @modelo.Versao, idUsuario: @modelo.idUsuario } }
    end
  ...
  test "should update modelo" do
    patch modelo_url(@modelo), params: { modelo: { Atualizado_em: @modelo.Atualizado_em, Criado_em: @modelo.Criado_em, Descricao: @modelo.Descricao, Nome: @modelo.Nome, Status: @modelo.Status, Versao: @modelo.Versao, idUsuario: @modelo.idUsuario } }
